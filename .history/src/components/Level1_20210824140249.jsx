...
function TouchGameLevelOne() {
  ...
  const getDotBigger = useCallback((e) => {
    ...
    const dimensions = board.getBoundingClientReact()
    ...
    // console.log(stageRef.current.getBoundingClientReact())
    console.log(board.getBoundingClientReact())
  }, [setSize, size])
    ...
    <div className="yellow-board">
      ...
      >
        ...
        <div
          ...
          {!gameOver ? null : <button type="button" onClick={refreshPage}> <span>Reload</span> </button>}
        </div>
      </div>
